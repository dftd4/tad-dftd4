...
refs: dict[str, Refs] = {
    ...
    "AmF3": {
        ...
        "disp3": torch.tensor(
            [
                +6.1984245166280914e-09,
                +9.7540830195965035e-08,
                +9.7537990979328839e-08,
                +9.7541394042961008e-08,
            ],
            dtype=torch.double,
        ),
    },
    "actinides": {
        "disp": torch.tensor(
            [
                -6.8957394055248226e-03,
                -8.4797683330827475e-03,
                -1.5603308158454633e-02,
                -9.3107423998999347e-03,
                -9.9142055393934489e-03,
                -8.3542496945573589e-03,
                -5.6297854698769186e-03,
                -1.0971415900997648e-02,
                -1.4862366435705165e-02,
                -6.5560275264338712e-03,
                -8.7884416715462710e-03,
                -1.2145731292749552e-02,
                -1.7381824161274748e-02,
                -1.4909119553136140e-02,
                -1.5204307779232252e-02,
                -1.0510461249189841e-02,
                -1.7831081379221809e-02,
            ],
            dtype=torch.double,
        ),
        "disp2": torch.tensor(
            [
                -6.9029447043734626e-03,
                -8.4872634899207256e-03,
                -1.5627451039174890e-02,
                -9.3253972761693695e-03,
                -9.9175392718104643e-03,
                -8.3683791737566640e-03,
                -5.6455809712629172e-03,
                -1.0985588536472012e-02,
                -1.4875196355901154e-02,
                -6.5726820568800326e-03,
                -8.7988326403324116e-03,
                -1.2170807689935868e-02,
                -1.7398030359542342e-02,
                -1.4926488602130264e-02,
                -1.5212486331044052e-02,
                -1.0540147291395551e-02,
                -1.7838353072418434e-02,
            ],
            dtype=torch.double,
        ),
        "disp3": torch.tensor(
            [
                7.2052988486402141e-06,
                7.4951568379785491e-06,
                2.4142880720257069e-05,
                1.4654876269435275e-05,
                3.3337324170155559e-06,
                1.4129479199305550e-05,
                1.5795501385998455e-05,
                1.4172635474363722e-05,
                1.2829920195989997e-05,
                1.6654530446161486e-05,
                1.0390968786140908e-05,
                2.5076397186315482e-05,
                1.6206198267595010e-05,
                1.7369048994125034e-05,
                8.1785518118009312e-06,
                2.9686042205711026e-05,
                7.2716931966261273e-06,
            ],
            dtype=torch.double,
        ),
    },
