    ...
    "AmF3": Refs(
        {
            "q": torch.tensor(
                [
                    6.352363671348717e-01,
                    -2.117462362670332e-01,
                    -2.117468436581089e-01,
                    -2.117432872097296e-01,
                ],
                dtype=torch.float64,
            ),
            "disp": torch.tensor(
                [
                    -9.3997982313329337e-04,
                    -4.6301059954583521e-04,
                    -4.6297660992900051e-04,
                    -4.6301394398860047e-04,
                ],
                dtype=torch.double,
            ),
            "disp2": torch.tensor(
                [
                    -9.3998602155777051e-04,
                    -4.6310814042444968e-04,
                    -4.6307414796839725e-04,
                    -4.6311148543106215e-04,
                ],
                dtype=torch.double,
            ),
            "disp3": torch.tensor(
                [
                    +6.1984244771259546e-09,
                    +9.7540878614445899e-08,
                    +9.7538039396719123e-08,
                    +9.7541442461658528e-08,
                ],
                dtype=torch.double,
            ),
        }
    ...
    "actinides": Refs(
        {
            "q": torch.tensor(
                [
                    -3.305094571137845e-01,
                    1.045149602532968e-01,
                    -1.773960379881043e00,
                    3.331467348040358e-01,
                    4.951411452461927e-01,
                    4.707822787779681e-02,
                    2.743911400307595e-01,
                    3.246927331906781e-01,
                    1.425159600492128e-01,
                    1.419982718793466e-01,
                    2.277998732736134e-01,
                    2.177188049669549e-01,
                    1.066816495299460e-01,
                    1.796290415002953e-01,
                    -2.972753601075876e-01,
                    -3.751406822706739e-01,
                    1.815773367709599e-01,
                ],
                dtype=torch.float64,
            ),
            "disp": torch.tensor(
                [
                    -6.9063555211996757e-03,
                    -8.4866081258503610e-03,
                    -1.5606957961072051e-02,
                    -9.3150642014858242e-03,
                    -9.9199178790030373e-03,
                    -8.3652539938101449e-03,
                    -5.6334500079658475e-03,
                    -1.0979193521027822e-02,
                    -1.4870307730427973e-02,
                    -6.5565983338060595e-03,
                    -8.7933294187513538e-03,
                    -1.2163908672091538e-02,
                    -1.7407687160723322e-02,
                    -1.4920876705972700e-02,
                    -1.5225191869198093e-02,
                    -1.0681949263575337e-02,
                    -1.7858429194433208e-02,
                ],
                dtype=torch.double,
            ),
            "disp2": torch.tensor(
                [
                    -6.9135714732367713e-03,
                    -8.4941422750580454e-03,
                    -1.5631214742266784e-02,
                    -9.3297927080381766e-03,
                    -9.9232835793580977e-03,
                    -8.3794362774539093e-03,
                    -5.6493241701450541e-03,
                    -1.0993455185527931e-02,
                    -1.4883220543276156e-02,
                    -6.5732688389917391e-03,
                    -8.8037781207156284e-03,
                    -1.2189099473023848e-02,
                    -1.7423942577670957e-02,
                    -1.4938355586051829e-02,
                    -1.5233384726485381e-02,
                    -1.0712106674960588e-02,
                    -1.7865709637713410e-02,
                ],
                dtype=torch.double,
            ),
            "disp3": torch.tensor(
                [
                    +7.2159520370904534e-06,
                    +7.5341492076903970e-06,
                    +2.4256781194729662e-05,
                    +1.4728506552354082e-05,
                    +3.3657003550729202e-06,
                    +1.4182283643768106e-05,
                    +1.5874162179205514e-05,
                    +1.4261664500123273e-05,
                    +1.2912812848184835e-05,
                    +1.6670505185681039e-05,
                    +1.0448701964276458e-05,
                    +2.5190800932319163e-05,
                    +1.6255416947617772e-05,
                    +1.7478880079133499e-05,
                    +8.1928572872919559e-06,
                    +3.0157411385263311e-05,
                    +7.2804432801869369e-06,
                ],
                dtype=torch.double,
            ),
        }
