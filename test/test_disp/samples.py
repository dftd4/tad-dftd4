    ...
    "AmF3": Refs(
        {
            ...
            "disp": torch.tensor(
                [
                    -9.3960116555182624e-04,
                    -4.6280459295405140e-04,
                    -4.6277062060098238e-04,
                    -4.6280793520723541e-04,
                ],
                dtype=torch.double,
            ),
            "disp2": torch.tensor(
                [
                    -9.3960735964556687e-04,
                    -4.6290205209913919e-04,
                    -4.6286807690883289e-04,
                    -4.6290539491577494e-04,
                ],
                dtype=torch.double,
            ),
            "disp3": torch.tensor(
                [
                    +6.1940937406331102e-09,
                    +9.7459145087812312e-08,
                    +9.7456307850505277e-08,
                    +9.7459708539529044e-08,
                ],
                dtype=torch.double,
            ),
        }
    ...
    "actinides": Refs(
        {
            ...
            "disp": torch.tensor(
                [
                    -6.9077485181144897e-03,
                    -8.4886887399048434e-03,
                    -1.5589303196460312e-02,
                    -9.3154295393771836e-03,
                    -9.9218046362659004e-03,
                    -8.3640999536631917e-03,
                    -5.6322035065770265e-03,
                    -1.0978111931273979e-02,
                    -1.4875736264909220e-02,
                    -6.6166224624100859e-03,
                    -8.7972117832679480e-03,
                    -1.2168952399951156e-02,
                    -1.7408470242384642e-02,
                    -1.4928775851538770e-02,
                    -1.5225287216012236e-02,
                    -1.0681974287191583e-02,
                    -1.7862860006978613e-02,
                ],
                dtype=torch.double,
            ),
            "disp2": torch.tensor(
                [
                    -6.9149788562442790e-03,
                    -8.4962327642484174e-03,
                    -1.5613560786167961e-02,
                    -9.3301816878467690e-03,
                    -9.9251744845758171e-03,
                    -8.3782962725212941e-03,
                    -5.6480824985472586e-03,
                    -1.0992404495832688e-02,
                    -1.4888643172914474e-02,
                    -6.6334411082871591e-03,
                    -8.8076579284360086e-03,
                    -1.2194178898565337e-02,
                    -1.7424757421622160e-02,
                    -1.4946257122650740e-02,
                    -1.5233505100120818e-02,
                    -1.0712129940401221e-02,
                    -1.7870150980779705e-02,
                ],
                dtype=torch.double,
            ),
            "disp3": torch.tensor(
                [
                    +7.2303381297893667e-06,
                    +7.5440243435735760e-06,
                    +2.4257589707649145e-05,
                    +1.4752148469585554e-05,
                    +3.3698483099159523e-06,
                    +1.4196318858102793e-05,
                    +1.5878991970232019e-05,
                    +1.4292564558710473e-05,
                    +1.2906908005254225e-05,
                    +1.6818645877072989e-05,
                    +1.0446145168060084e-05,
                    +2.5226498614181619e-05,
                    +1.6287179237516917e-05,
                    +1.7481271111969254e-05,
                    +8.2178841085809071e-06,
                    +3.0155653209638006e-05,
                    +7.2909738010926691e-06,
                ],
                dtype=torch.double,
            ),
        }
